...
if ($realpath === false || strpos($realpath, realpath($uploadDir)) !== 0) {
    showErrorAndExit('Het bestand kon niet worden gevonden. Het kan zijn dat het bestand is verlopen of nog niet is aangemaakt. Probeer eerst een nieuw bestand te uploaden.');
}
...
function showErrorAndExit($message) {
    ...
    <head>
        ...
        <title>Fout bij downloaden</title>
